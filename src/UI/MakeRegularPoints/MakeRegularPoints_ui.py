...
class Ui_RegularPointsDialog(object):
    def setupUi(self, RegularPointsDialog):
        ...
        RegularPointsDialog.resize(382, 261)
        ...
        self.picNum = QtWidgets.QSpinBox(RegularPointsDialog)
        self.picNum.setMaximum(1000)
        self.picNum.setProperty("value", 50)
        self.picNum.setObjectName("picNum")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.picNum)
        ...
        RegularPointsDialog.setTabOrder(self.firstPK, self.picNum)
        RegularPointsDialog.setTabOrder(self.picNum, self.proNum)
